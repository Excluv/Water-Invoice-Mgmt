...
{
    public partial class Search_Invoice_ByCustomer : Form
    {
        ...
        public Search_Invoice_ByCustomer(Invoice ParentForm, string SqlPath)
        {
            InitializeComponent();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd = new SqlCommand("Search_Invoice_ByCustomer", conn);
